...
from app.routers import auth, prioritries, entries, days, todos, projects, categories, active_item, item_refs, scratch_pad, dashboard, daily_notes, spending, tags, attachments
...
app.include_router(item_refs.router)
